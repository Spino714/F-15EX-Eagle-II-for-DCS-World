...
local f15_aim120c5_name = 'AIM-120C-5 AMRAAM - Active Rdr AAM'
local f15_aim120c5_mass = 161.5
local pylon_mass = 1.0

local f15_aim120c5_warhead = enhanced_a2a_warhead(9, 178)

local F15_aim120c5_AA = {
    category        = CAT_AIR_TO_AIR,
    name            = f15_aim120c5_name,
    model           = 'aim-120c',
    user_name       = _(f15_aim120c5_name),
	wsTypeOfWeapon 	= {wsType_Weapon,wsType_Missile,wsType_AA_Missile,WSTYPE_PLACEHOLDER},
    mass            = f15_aim120c5_mass,
    ...
    warhead         = f15_aim120c5_warhead,
    warhead_air     = f15_aim120c5_warhead,
    ...
    shape_table_data = {
        {
            ...
            life     = 1,
            fire     = {0, 1},
            username = "120C5",		--Shortened name for cockpit displays
	...
	ModelData = {   58 ,  -- model params count
				...
				--	t_statr		t_b		t_accel		t_march		t_inertial		t_break		t_end			-- Stage
					-1.0,		-1.0,	13.0,  		0.0,		0.0,			0.0,		1.0e9,         -- time of stage, sec
					 0.0,		0.0,	4.9,		0.0,		0.0,			0.0,		0.0,           -- fuel flow rate in second, kg/sec(секундный расход массы топлива кг/сек)
					 0.0,		0.0,	12000.0,	0.0,		0.0,			0.0,		0.0,           -- thrust, newtons
...
declare_loadout({
	...
	wsTypeOfWeapon	=	F15_aim120c5_AA.wsTypeOfWeapon,
	displayName		=	_(f15_aim120c5_name),
	attribute		=	{4,	4,	32, WSTYPE_PLACEHOLDER},
	Count			=	1,
	Weight			=	f15_aim120c5_mass + pylon_mass,
	Elements		=	
	{
		{
...
declare_loadout({
    category        = CAT_AIR_TO_AIR,
    CLSID           = "{LAU_115_2xAIM120C5}",
    wsTypeOfWeapon  = F15_aim120c5_AA.wsTypeOfWeapon,
    attribute       = {4, 4, 32, WSTYPE_PLACEHOLDER},
    Count           = 2,
    Picture         = "us_AIM-120C.png",
    displayName     = _('LAU-115 2 x ' .. f15_aim120c5_name),
    Weight          = f15_aim120c5_mass * 2 + 50,
	Elements = {
...
declare_loadout({
    category        = CAT_AIR_TO_AIR,
    CLSID           = "{UPPERW_2xAIM120C5}",
    wsTypeOfWeapon  = F15_aim120c5_AA.wsTypeOfWeapon,
    attribute       = {4, 4, 32, WSTYPE_PLACEHOLDER},
    Count           = 2,
    Picture         = "us_AIM-120C.png",
    displayName     = _('2 x ' .. f15_aim120c5_name),
    Weight          = f15_aim120c5_mass * 2 + 50,
	Elements = {
...
declare_loadout({
    category        = CAT_AIR_TO_AIR,
    CLSID           = "{OUTERW_2xAIM120C5}",
    wsTypeOfWeapon  = F15_aim120c5_AA.wsTypeOfWeapon,
    attribute       = {4, 4, 32, WSTYPE_PLACEHOLDER},
    Count           = 2,
    Picture         = "us_AIM-120C.png",
    displayName     = _('2 x ' .. f15_aim120c5_name),
    Weight          = f15_aim120c5_mass * 2 + 150,
	Elements = {
...
declare_loadout({
    category        = CAT_AIR_TO_AIR,
    CLSID           = "{AMBER_2xAIM120C5}",
    wsTypeOfWeapon  = F15_aim120c5_AA.wsTypeOfWeapon,
    attribute       = {4, 4, 32, WSTYPE_PLACEHOLDER},
    Count           = 2,
    Picture         = "us_AIM-120C.png",
    displayName     = _('AMBER 2*' .. f15_aim120c5_name),
    Weight          = f15_aim120c5_mass * 2 + 150,
	Elements = {
