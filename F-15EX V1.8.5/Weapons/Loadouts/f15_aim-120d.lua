...
local f15_aim120d_name = 'AIM-120D AMRAAM - Active Radar AAM'
local f15_aim120d_mass = 161.5
local pylon_mass = 1.0

local f15_aim120d_warhead = enhanced_a2a_warhead(9, 178)

local F15_aim120d_AA = {
    category        = CAT_AIR_TO_AIR,
    name            = f15_aim120d_name,
    model           = 'aim-120c',
    user_name       = _(f15_aim120d_name),
	wsTypeOfWeapon 	= {wsType_Weapon,wsType_Missile,wsType_AA_Missile,WSTYPE_PLACEHOLDER},
    mass            = f15_aim120d_mass,
    ...
    warhead         = f15_aim120d_warhead,
    warhead_air     = f15_aim120d_warhead,
    ...
    shape_table_data = {
        {
            ...
            life     = 1,
            fire     = {0, 1},
            username = "120D",		--Shortened name for cockpit displays
	...
	ModelData = {   58 ,  -- model params count
				...
				--	t_statr		t_b		t_accel		t_march		t_inertial		t_break		t_end			-- Stage
					-1.0,		-1.0,	20.0,  		0.0,		0.0,			0.0,		1.0e9,         -- time of stage, sec
					 0.0,		0.0,	3.5,		0.0,		0.0,			0.0,		0.0,           -- fuel flow rate in second, kg/sec(секундный расход массы топлива кг/сек)
...
declare_weapon(F15_aim120d_AA)

declare_loadout({
	category		=	CAT_AIR_TO_AIR,
	CLSID			= 	"{F15_AIM120D}",
	Picture			=	"AIM-120D.png",
	wsTypeOfWeapon	=	F15_aim120d_AA.wsTypeOfWeapon,
	displayName		=	_(f15_aim120d_name),
	attribute		=	{4,	4,	32,	WSTYPE_PLACEHOLDER},
	Count			=	1,
	Weight			=	f15_aim120d_mass + pylon_mass,
	Elements		=	
	{
		{
...
declare_loadout({
    category        = CAT_AIR_TO_AIR,
    CLSID           = "{LAU_115_2xAIM120D}",
    wsTypeOfWeapon  = F15_aim120d_AA.wsTypeOfWeapon,
    attribute       = {4, 4, 32, WSTYPE_PLACEHOLDER},
    Count           = 2,
    Picture         = "AIM-120D.png",
    displayName     = _('LAU-115 with 2 x ' .. f15_aim120d_name),
    Weight          = f15_aim120d_mass * 2 + 50,
	Elements = {
...
declare_loadout({
    category        = CAT_AIR_TO_AIR,
    CLSID           = "{UPPERW_2xAIM120D}",
    wsTypeOfWeapon  = F15_aim120d_AA.wsTypeOfWeapon,
    attribute       = {4, 4, 32, WSTYPE_PLACEHOLDER},
    Count           = 2,
    Picture         = "AIM-120D.png",
    displayName     = _('2 x ' .. f15_aim120d_name),
    Weight          = f15_aim120d_mass * 2 + 50,
	Elements = {
...
declare_loadout({
    category        = CAT_AIR_TO_AIR,
    CLSID           = "{OUTERW_2xAIM120D}",
    wsTypeOfWeapon  = F15_aim120d_AA.wsTypeOfWeapon,
    attribute       = {4, 4, 32, WSTYPE_PLACEHOLDER},
    Count           = 2,
    Picture         = "us_AIM-120C.png",
    displayName     = _('2 x ' .. f15_aim120d_name),
    Weight          = f15_aim120d_mass * 2 + 150,
	Elements = {
...
declare_loadout({
    category        = CAT_AIR_TO_AIR,
    CLSID           = "{AMBER_2xAIM120D}",
    wsTypeOfWeapon  = F15_aim120d_AA.wsTypeOfWeapon,
    attribute       = {4, 4, 32, WSTYPE_PLACEHOLDER},
    Count           = 2,
    Picture         = "AIM-120D.png",
    displayName     = _('AMBER 2*' .. f15_aim120d_name),
    Weight          = f15_aim120d_mass * 2 + 150,
	Elements = {
