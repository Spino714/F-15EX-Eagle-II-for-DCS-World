...
local ld10_name  = 'AGM-88G AARGM-ER'
local ld10_model = 'aargm_er'
local ld10_mass  = 391.0
local pylon_mass = 61.0
...
declare_loadout({
    ...
    Cx_pil      	= 0.000859765625,
    Count       	= 2,
    Weight      	= ld10_mass + 120,
    Elements    	= {
		[1]	=
		{
			--Rotation	=	{180, 0, 0}, 
			ShapeName	=	"f-15ex_pylon1",--outer pylon     
			IsAdapter 	= true,
		},
		[2]	=
		{
			Position	=	{1.2,	-0.2,  -0.38},   
			ShapeName	=	"aargm_er", 
			Rotation    =   {90,0,0}
		},
		[3]	=
