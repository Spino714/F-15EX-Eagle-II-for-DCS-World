...
local f15_aim9x_name = 'AIM-9X Sidewinder IR AAM'
local f15_aim9x_mass = 85.5
local pylon_mass = 1.0

F15_AIM9X_AA = {
    category        = CAT_AIR_TO_AIR,
    name            = f15_aim9x_name,
    user_name       = _(f15_aim9x_name),
...
declare_loadout({
	...
	wsTypeOfWeapon	= F15_AIM9X_AA.wsTypeOfWeapon,
    displayName 	= _("AIM-9X F-15"),
    Cx_pil      	= 0.0001,
    Count       	= 1,
    Weight      	= f15_aim9x_mass + pylon_mass,
    Elements    	= {
		[1]	=
		{
			Position	=	{0, 0, 0},
...
declare_loadout({
    ...
    attribute       = {4,4,32,WSTYPE_PLACEHOLDER},
	wsTypeOfWeapon	= F15_AIM9X_AA.wsTypeOfWeapon,
    displayName 	= _("2*AIM-9X"),
    Cx_pil      	= 0.0001,
    Count       	= 2,
    Weight      	= f15_aim9x_mass * 2,
    Elements    	= {
		{
			Position	=	{0, 0, 0},
			ShapeName	=	"",
		...
		{
			Position	=	{0.9,	0.01,	0.4}, --1
			ShapeName	=	"aim-9x",
		},
		{
			Position	=	{0.9,	0.01,	-0.4}, --2
			ShapeName	=	"aim-9x",
		},
    }, -- end of Elements
})
...
declare_loadout({
    ...
    attribute       = {4,4,32,WSTYPE_PLACEHOLDER},
	wsTypeOfWeapon	= F15_AIM9X_AA.wsTypeOfWeapon,
    displayName 	= _("Outer Wing Launcher 2* AIM-9X"),
    Cx_pil      	= 0.0001,
    Count       	= 2,
    Weight      	= f15_aim9x_mass * 2 + 150,
    Elements    	= {
		{
			Position	=	{0, 0, 0},
			ShapeName	=	"WingLauncher",
			IsAdapter 	= true,
		},
		{
			Position	=	{1.0,	-0.13,	0.25}, --1
			ShapeName	=	"aim-9x",
		},
		{
			Position	=	{1.0,	-0.13,	-0.25}, --2
			ShapeName	=	"aim-9x",
		},
    }, -- end of Elements
})